# DisplayName: Jolla sweet/@ARCH@ (release) 1
...
repo --name=adaptation-common-sweet-@RELEASE@ --baseurl=https://releases.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-common/@ARCH@/
repo --name=adaptation-community-common-sweet-@RELEASE@ --baseurl=https://repo.sailfishos.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
patterns-sailfish-device-configuration-sweet
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/sweet
